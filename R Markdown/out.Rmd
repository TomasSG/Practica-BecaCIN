...
Ahora que tenemos un modelo elegido buscamos puntos influyentes
...
En principio, la observación no presenta ninguna irregularidad pero vamos a sacarla y volver a ajustar un modelo para ver si resulta en alguna mejoría.
...
De vuelta observamos que todos los puntos tienen una distancia de cook menor a 1. Como no hay una gran separación en las primeras posiciones, no evaluamos de sacar alguna de las observaciones.
